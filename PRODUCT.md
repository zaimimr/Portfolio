...
## Users
Primary: recruiters, potential freelance clients and fellow developers evaluating Zaim Imran's work in a quick skim. Secondary: Zaim himself as the sole admin, using a hidden portal weekly as the hub for his side projects and their dashboards.
...
## Operating Context
Hosted on Vercel from a single Next.js repo. Content edited through Val Studio at /val (git commits on publish). Admin at /admin, GitHub OAuth, allowlisted to Zaim only. Projects carry dual taxonomy: category (work/freelance/hobby) and type (website/app/game/non-technical).
